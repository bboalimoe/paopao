...
DATABASES = {
    'default': {
        ...
        'NAME': 'paopao',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&amp;movsbez5xb3d4&amp;feio4+bi$^5%-yn)ug(1$6=ykvvwur_8+%*'
...
TEMPLATE_DIRS = (os.path.join(os.path.dirname(__file__), 'service/templates'))
